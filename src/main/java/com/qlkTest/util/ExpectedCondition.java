...
* @version 创建时间：2016年2月4日 下午6:18:21 
* 类说明 
*/
 ...
 * <p>
 * Note that it is expected that ExpectedConditions are idempotent. They will be
 * called in a loop by the {@link WebDriverWait} and any modification of the
